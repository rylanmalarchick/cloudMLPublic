...
\begin{itemize}[leftmargin=*]
	...
	\item \textbf{Open-source framework:} Release of CloudMLPublic, a production-grade implementation with comprehensive uncertainty quantification, 92\% test pass rate, and full reproducibility infrastructure to accelerate atmospheric ML research.
\end{itemize}
...
\begin{enumerate}[leftmargin=*]
	\item \textbf{ERA5 atmospheric features (13):}
	      \begin{itemize}
		      \item 2-meter temperature (t2m, K)
		      \item 2-meter dewpoint (d2m, K)
		      \item Surface pressure (sp, Pa)
		      \item Total cloud cover (tcc, fraction)
		      \item Low cloud cover (lcc, fraction)
		      \item Medium cloud cover (mcc, fraction)
		      \item High cloud cover (hcc, fraction)
		      \item 10-meter U wind component (u10, m/s)
		      \item 10-meter V wind component (v10, m/s)
		      \item Boundary layer height (blh, m)
		      \item Convective available potential energy (cape, J/kg)
		      \item Total column water vapor (tcwv, kg/m$^2$)
		      \item Skin temperature (skt, K)
	      \end{itemize}

	\item \textbf{Geometric features (5):}
	      \begin{itemize}
		      \item Solar zenith angle (solar\_zenith\_angle, degrees)
		      \item Solar azimuth angle (solar\_azimuth\_angle, degrees)
		      \item View zenith angle (view\_zenith\_angle, degrees)
		      \item View azimuth angle (view\_azimuth\_angle, degrees)
		      \item Relative azimuth (relative\_azimuth, degrees)
	      \end{itemize}
\end{enumerate}
...
\begin{enumerate}[leftmargin=*]
	...
	\item \textbf{Open-source framework released:} CloudMLPublic provides production-grade infrastructure with comprehensive uncertainty quantification and 92\% test pass rate to support reproducible atmospheric ML research.
\end{enumerate}
